...
import { AgreementNavigation, navigateAgreementBack, navigateAgreementHome } from "../agreement-navigation";
...
const actionAbi = [
  "function cancel()", "function confirmDelivery()",
...
export default function AgreementDetailsPage() {
  ...
  if (error && !detail) return <main className="dashboard-shell"><AgreementNavigation onBack={() => navigateAgreementBack(router)} onHome={() => navigateAgreementHome(router)} /><p className="dash-error">{error}</p></main>;
  if (!detail) return <main className="dashboard-shell"><AgreementNavigation onBack={() => navigateAgreementBack(router)} onHome={() => navigateAgreementHome(router)} /><p className="dash-muted">Reading and reconciling contract state...</p></main>;
