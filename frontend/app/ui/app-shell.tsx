...
export function AppShell({ address, networkLabel, section, setSection, lock, children }: { address: string; networkLabel: string; section: AppSection; setSection: (value: AppSection) => void; lock: () => void; children: ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-foot"><div className="network-pill"><i />{networkLabel}</div><button className="lock-button" onClick={lock}>Disconnect Wallet</button></div>
    </aside>
